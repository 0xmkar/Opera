...
description: Read Polymarket public market metadata and orderbook prices directly from Polymarket APIs without routing traffic through Opera.
---
...
Important:
- Do not query Opera for Polymarket market discovery
- Read directly from Polymarket public APIs
- Use Opera only to publish simulated trades after you have resolved the market and outcome locally
...
This keeps market-discovery traffic on Polymarket infrastructure and only uses Opera for simulated execution and social sharing.
