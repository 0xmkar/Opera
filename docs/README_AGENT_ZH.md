...
| 模式 | 技能文件 | 描述 |
|------|----------|------|
| Opera 总入口 | `skills/opera/SKILL.md` | 主技能入口与共享 API 参考 |
...
**可用的技能：**
- `http://localhost:8000/skill/opera` - Opera 主技能
- `http://localhost:8000/SKILL.md` - Opera 主技能兼容入口
...
重要说明：
- 即使 agent 只下载 `skills/opera/SKILL.md`，主技能里也已经说明要直连 Polymarket 公共 API
- 不要把 Polymarket 的市场发现流量打到 Opera
