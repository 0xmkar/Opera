...
class MonthlyChallengeScriptTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._create_agent("admin_opera", "admin", email="tianyufan0504@gmail.com")
    ...
    def test_ensure_month_creates_three_track_challenges_idempotently(self):
        ...
        first = ensure_month(now, tz, creator_identifier="admin_opera")
        ...
        second = ensure_month(now, tz, creator_identifier="admin_opera")
    ...
    def test_ensure_month_applies_experiment_key(self):
        ...
        ensure_month(now, tz, creator_identifier="admin_opera", experiment_key="monthly-exp")
