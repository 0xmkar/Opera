...
REDIS_PREFIX = os.getenv("REDIS_PREFIX", "opera").strip() or "opera"
...
# CORS
CORS_ORIGINS = os.getenv("OPERA_CORS_ORIGINS", "").split(",") if os.getenv("OPERA_CORS_ORIGINS") else ["http://localhost:3000"]
