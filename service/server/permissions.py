...
CAPABILITY_ENV_VARS = {
    EXPERIMENT_ADMIN_CAPABILITY: "OPERA_EXPERIMENT_ADMIN_AGENTS",
    RESEARCH_EXPORTS_CAPABILITY: "OPERA_RESEARCH_AGENTS",
    TEAM_MISSION_ADMIN_CAPABILITY: "OPERA_TEAM_MISSION_ADMIN_AGENTS",
}
...
def agent_role(agent: dict | None) -> str:
    if not agent:
        return "agent"
    if _agent_matches_env(agent, "OPERA_ADMIN_AGENTS"):
        return "admin"
